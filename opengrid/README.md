...
| `parts/opengrid_cupholder.scad` | Cup holder that mounts to openGrid via a facade base |
| `parts/opengrid_inbox.scad` | Wall-mounted paper, envelope, and file inbox, mounted via openConnect slots ([docs](parts/opengrid_inbox.md)) |
